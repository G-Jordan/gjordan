...
(function(){
  ...
  function saveTheme(){
    ...
    (window.G73ThemeBridge?.saveTheme?.(theme) || localStorage.setItem("themeSettings", JSON.stringify(theme)));
  ...
  function resetTheme(){
    ...
    window.previewTheme?.();
    (window.G73ThemeBridge?.saveTheme?.(defaults) || localStorage.setItem("themeSettings", JSON.stringify(defaults)));
  }

  function exportTheme(){
    const settings = JSON.stringify(window.G73ThemeBridge?.loadTheme?.() || window.G73ThemeBridge?.safeParse?.(localStorage.getItem("themeSettings")) || {});
